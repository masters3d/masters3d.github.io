...
independent sources arriving at the same triad suggests it names something real.

But Nana's order (Guts, Stamina, Faith) is the order of urgency, not the order
of dependency. That's the part worth examining.

## The Order That Lands Versus the Order That Works

Nana leads with Guts because Buster needs it in the next five minutes. That's
...
well-executed wrong turns.

**Faith belongs first.** Not as a spiritual concept, but as the Searching move:
...
direction because the faith established it first.
...
without waiting for guaranteed outcomes.

**Stamina closes the loop.** Knowing and starting aren't enough. You have to
...
The [Quest Engine](/blog/quest-engine-the-why/) names these three forces:
...
cycle build on the last).

Nana asked Buster whether he believed he was good enough before she gave him the
...
they actually operate in is: **Faith. Guts. Stamina.**
