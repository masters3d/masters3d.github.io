...
it. Near the midpoint of _The Matrix_, Morpheus takes Neo into a dojo simulation
and says:
...
understanding this intellectually is not the same as living it. Neo _knows_ he
...
_returning_ (and that's where renewal lives).
...
decided this is the path, and you're taking it (and that word, _taking_, is more
...
never do that, because you've changed), but to the work of asking: _Was that the
right path? What has the walking taught me that the knowing never could?_

Steve Jobs, in his
[2005 Stanford commencement address](https://stevejobsarchive.com/stories/stay-hungry-stay-foolish),
said something that only makes sense from the vantage point of return: _"You
can't connect the dots looking forward; you can only connect them looking
backward."_ He was talking about dropping out of Reed College, which led him to
...
During the return, they become a line.
...
This triad is exactly the cycle in the
...
destination you've decided is worth reaching.
...
_The Matrix quote originates from the Wachowskis' 1999 film (spoken by Morpheus,
...
[2005 Stanford commencement address](https://stevejobsarchive.com/stories/stay-hungry-stay-foolish),
explored in full in
[Stay Hungry. Stay Foolish.](/blog/stay-hungry-stay-foolish/). The proverb "it
...
[Quest Engine framework](/blog/quest-engine-the-why/) and its
[WHY layer](/blog/quest-engine-introduction/). See also the secular framing of
the same cycle in [Discovery, Play, Joy](/blog/secular-meaning-of-life/)._
