...
[The Bicycle of the Mind](/blog/bicycle-of-the-mind-fast-slow-agents/); this is
...
into when it is not doing anything you can point to) is not idle. It is running.

## Boredom Is the Doorway

If the background brain does the interesting work, then boredom is not wasted
...
dead-end kind, and fight to unblock the third.

## Why More Hours Can Make Creative Work Worse

All of this leads somewhere practical, which is that the value of an extra hour
...
creative ceiling to hit because there is nothing creative being asked of you.

Creative work does not behave that way. When the task is genuinely difficult and
