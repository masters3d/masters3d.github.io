+++
title = "From Creative Tools to Software Engineering"
date = "2016-10-25"
description = "How a yellow film camera, video editing, web design, Python, Swift, and open source gradually revealed that programming had been part of my creative work all along."
template = "blog-post.html"
[taxonomies]
categories = ["Field Notes"]
tags = ["origin-story", "software-engineering", "programming", "creative-tools", "swift", "python", "open-source"]
[extra]
...
At the time, that looked like a list of unrelated choices. I thought I had to
pick one. It took years to notice that I kept reaching for the same thing in
every field: a tool that would let me make something that did not exist before.

## The yellow camera

Growing up, I did not have access to many technical things, but I did have a
...
those photos now, but I remember the feeling of making them.

That camera introduced me to creating with a technical tool. Computers became
...
it). The ambition was real even if the spelling was not.

During my freshman year of college, I became convinced that programming was not
...
I edited XML for Final Cut Pro timelines. I added small expressions to After
...
creative tool exposed a programmable seam, I pulled on it.

My first computer that felt entirely my own was a 2007 MacBook Pro with an Intel
...
The web changed while I was away. The iPhone helped end the Flash era. HTML5 and
...
the web had become a much more interesting creative medium.

## Finding languages I could understand

In 2013, I started watching Udacity's Python courses to learn backend web
...
I had wanted to make iPhone apps, but Objective-C never clicked for me. Then
...
evolution proposals to understand how it was being built.

Learning Swift gave me a bridge to other languages. I picked up Java, returned
...
I made my first iOS game in 2014. It was a small Breakout-style app, but seeing
...
start a conversation about problems I had implementing the game.

In 2015, I began submitting exercises to Exercism. That community taught me how
...
technologies after attending Code Fellows.

## I did not have to choose

When I look back at that original list of careers, I think the list was asking
...
The thread was never a particular job title. It was the pleasure of creating
