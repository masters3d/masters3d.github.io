...
Apple did almost everything right with Swift on the technical side. They made it
...
one company's stack, it is a runaway success.

The trouble is that "one company's stack" is exactly the boundary Swift has
...
career dead end, no matter how elegant it is.

This is the same wall C# ran into for years. C# is a genuinely good language,
...
If a great language is not enough, what actually moves a new language into a
...
Rust is the clearest example I can point to right now. Rust is popular today
...
top-down commitment, even a superior language stays a hobby project.

Swift never got that outside of Apple, and Apple had little reason to fight for
...
world. And it still failed. The project was archived in 2021.

Why did it fail? The same document that argued for Swift also spelled out,
...
There was a path out of this trap, and it ran through open source. The way a
...
you convince skeptical engineers that a language has a life of its own.

Swift got a real shot at this with Ladybird, the new web browser being built
...
[Language Choice in the LLM Era](/blog/language-choice-in-the-llm-era/)). That
