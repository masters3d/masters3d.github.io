+++
title = "2026: iPad Pro, Vision Pro, and a Device Mostly in My Drawer"
date = "2026-07-25"
description = "Looking back at ten years with the 12.9-inch iPad Pro, why it became a single-purpose learning device, and what that suggests about the Vision Pro."
template = "blog-post.html"
[taxonomies]
categories = ["Field Notes"]
tags = ["ipad", "ipad-pro", "vision-pro", "apple", "retrospective", "mobile", "learning"]
[extra]
...
I mostly used the iPad when I traveled to watch movies on the plane. It is
...
I had used it last. I never felt that I got all the use I could out of it.

In 2015, I also bought a MacBook Pro. It became my primary device, even for
...
than consume something.

I had hoped the input story would get better. I wanted typing onscreen to feel
...
the first year. Over time, they mattered more than the impressive hardware.

## A Single-Purpose Learning Device

At some point, the only time I used the iPad was to play DragonBox Algebra with
my kid. When my daughter was learning piano, she used the iPad with Simply Piano
to learn songs. That was a perfect use for the big screen.

Around the same time, I started noticing that many payment kiosks embedded a
...
especially for learning games like DragonBox and Simply Piano.

All the uses I highlighted can also be handled by Android tablets, so what is
...
me. It was at its best when it became a single-purpose device.

## Coming Back to Vision Pro

What is the big deal about this new device? The clearest possibility I see is
...
when somebody is trying to learn something new.

The Vision Pro takes that idea beyond the screen. Whether that additional space
...
The interesting part is not that the iPad failed. It did many things well, and I
...
was gone, the iPad moved to the drawer and mostly stayed there.

_In 2016, I was waiting for the input story to make the iPad feel natural. In
...
the question I would bring to the Vision Pro._
